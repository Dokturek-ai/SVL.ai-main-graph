...
RUN --mount=type=cache,id=s/aa664336-9636-42d0-a276-784a9573ad43-/root/.bun/install/cache,target=/root/.bun/install/cache \
    cd lightrag_webui \
...
RUN --mount=type=cache,id=s/aa664336-9636-42d0-a276-784a9573ad43-/root/.local/share/uv,target=/root/.local/share/uv \
